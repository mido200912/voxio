...
const Privacy = () => {
    ...
    return (
        <div className="legal-container" style={{ padding: '60px 20px', maxWidth: '900px', margin: '0 auto', lineHeight: '1.8', color: 'var(--text-primary)' }}>
            ...
            <p>Welcome to VOXIO. We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regards to your personal information, please contact us.</p>
            ...
            <p><strong>Email:</strong> voxio049@gmail.com</p>
        </div>
    );
};
