  ...
  const integrations = [
    {
      ...
      description: language === 'ar' ? 'روبوت محادثة ذكي على واتساب بيزنس' : 'Chatbot on WhatsApp Business',
      icon: <WhatsAppIcon />,
    ...
    {
      name: 'Instagram DMs',
      description: language === 'ar' ? 'أدر رسائل انستجرام بذكاء' : 'Manage Instagram messages intelligently',
      icon: <InstagramIcon />,
      status: t.integrations.available,
      iconClass: 'instagram',
      available: true
    },
    {
      ...
      description: language === 'ar'
        ? 'قم ببناء بوتات ذكية وسريعة لخدمة عملائك على مدار الساعة.'
        : 'Build smart and fast bots to serve your customers 24/7.',
      icon: <TelegramIcon />,
      status: t.integrations.available,
      iconClass: 'telegram',
      available: true
    ...
    },
    {
      name: 'X',
      description: language === 'ar'
        ? 'قريباً: إدارة الردود والرسائل الخاصة عبر منصة X.'
        : 'Manage Twitter replies and DMs via the X platform.',
      icon: <TwitterIcon />,
      status: t.integrations.soon,
      iconClass: 'twitter',
      available: false
      ...
      <div className="container">
        ...
        <div className="integrations-grid reveal-section" ref={revealRef}>
          {integrations.map((integration, index) => (
            ...
            >
              <div className={`integration-logo ${integration.iconClass}`}>
                {integration.icon}
              </div>
